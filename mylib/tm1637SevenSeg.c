 ...
 *
 * This is ATmega328p library for 4-Digit LED Display based on TM1637 chip. This c file contains the low and high level source code.
 * It uses software based clocking and communication with the TM1637 chip.  
 * 
 * Features:
